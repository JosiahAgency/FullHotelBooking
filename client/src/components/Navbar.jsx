        ...
        <nav
            ...
            <div className="flex items-center gap-3 lg:hidden"
                ...
                <img src={assets.menuIcon} alt='menu'
                     className={`h-4 ${isScrolled ? "invert" : ""} transition-all duration-500`}/>
                {user && (
                    <UserButton>
                        <UserButton.MenuItems>
                            <UserButton.Action label={`My Bookings`} labelIcon={<BookIcon/>}
            ...
            {/* Mobile Menu */}
            <div
                className={`fixed top-0 left-0 w-full h-screen bg-white text-base flex flex-col lg:hidden items-center justify-center gap-6 font-medium text-gray-800 transition-all duration-500 ${isMenuOpen ? "translate-x-0" : "-translate-x-full"}`}>
